...
##############################################################################
path_neg = "D:\SoftPackage\pycharm\PyCharmProject\MachineLearning\Data\SST-2_processed\\neg_processed.txt"
path_pos = "D:\SoftPackage\pycharm\PyCharmProject\MachineLearning\Data\SST-2_processed\pos_processed.txt"
##############################################################################
# 读取数据
...
t = Tokenizer()
t.fit_on_texts(docs)
vocab_size = len(t.word_index) + 1  # 因为用'0'去padding，所以t.word_index从1开始映射索引，这里的+1表示用于未知词
...
# summarize the model
model.summary()
to_file = "D:\SoftPackage\pycharm\PyCharmProject\MachineLearning\Data\\Model_png\\Glove_CNN_SST-2.png"
