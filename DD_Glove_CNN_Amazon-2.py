...
##############################################################################
path_neg = "D:\SoftPackage\pycharm\PyCharmProject\MachineLearning\Data\Amazon-2_processed\\neg_processed.txt"
path_pos = "D:\SoftPackage\pycharm\PyCharmProject\MachineLearning\Data\Amazon-2_processed\pos_processed.txt"
##############################################################################
# 读取数据
...
##############################################################################
# pos有3656659，总评论有4113049个，因此去除pos的113,049个，
# 形成4,000,000条Amazon-2数据
# 因此，3656659-113049=3543610
# 因此，3543610+456390=4000000
...
a = len(processed_neg_comments)
b= len(processed_pos_comments)
print(f"total: {a+b}")
##############################################################################
...
plt.show()
# fig.savefig('Amazon-2.png',dpi=900,format='png')
